                ...
                <form method="POST" action="{{ route('customers.update', $customer) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="address" 
                                  ...
                                  placeholder="آدرس کامل را وارد کنید">{{ old('address', $customer->address) }}</textarea>
                        @error('address')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="notes" 
                                  ...
                                  placeholder="یادداشت‌های مربوط به مشتری را وارد کنید">{{ old('notes', $customer->notes) }}</textarea>
                        @error('notes')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
